...
function semplice_get_module_svgs() {
	...
	// modules
	$modules = array('paragraph', 'text', 'fluidtext', 'image', 'gallery', 'video', 'spacer', 'button', 'oembed', 'portfoliogrid', 'singleproject', 'advancedportfoliogrid', 'code', 'share', 'socialprofiles', 'dribbble', 'instagram', 'gallerygrid', 'mailchimp', 'beforeafter', 'lottie', 'blogposts', 'blogarchives', 'blogsearch', 'blogcomments', 'marquee');
