...
class editor_api extends editor {
	...
	public function __construct() {
		...
		// modules list
		$modules_list = array('advancedportfoliogrid', 'blogarchives', 'blogposts', 'blogsearch', 'blogcomments', 'button', 'code', 'dribbble', 'gallery', 'image', 'lottie', 'oembed', 'paragraph', 'portfoliogrid', 'share', 'singleproject', 'socialprofiles', 'spacer', 'text', 'fluidtext', 'video', 'instagram', 'gallerygrid', 'mailchimp', 'beforeafter', 'marquee');
