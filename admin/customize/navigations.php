...
if(!class_exists('navigations')) {
	class navigations {
			...
			if(true !== $hide_menu) {
				if(is_array($navigation)) {
					...
					if(isset($navigation['menu_mouseover_color'])) {
						$output['css'] .= $li_selector . ' a:hover span, .' . $navigation['id'] . ' .navbar-inner nav ul li.wrap-focus a span, ' . $li_selector . '.current-menu-item a span, ' . $li_selector . '.current_page_item a span { color: ' . $navigation['menu_mouseover_color'] . '; }';
					...
					if(isset($navigation['menu_border_mouseover_color'])) {
						$output['css'] .= $li_selector . ' a:hover span, ' . $li_selector . '.current-menu-item a span, ' . $li_selector . '.current_page_item a span  { border-bottom-color: ' . $navigation['menu_border_mouseover_color'] . '; }';
					...
					if(isset($navigation['menu_active_font_family'])) {
						$output['css'] .= $li_selector . '.current-menu-item a span, ' . $li_selector . '.current_page_item a span { ' . semplice_get_font_family($navigation['menu_active_font_family']) . ' }';
						$output['css'] .= '[data-post-type="project"] .navbar-inner nav ul li.portfolio-grid a span, [data-post-type="post"] .navbar-inner nav ul li.blog-overview a span { ' . semplice_get_font_family($navigation['menu_active_font_family']) . ' }';
					}
					...
					if(isset($navigation['overlay_mouseover_color'])) {
						$output['css'] .= $li_selector . ' a:hover span, ' . $li_selector . '.current-menu-item a span, ' . $li_selector . '.current_page_item a span { color: ' . $navigation['overlay_mouseover_color'] . '; }';
						$output['css'] .= '[data-post-type="project"] ' . $li_selector . '.portfolio-grid a span, [data-post-type="post"] ' . $li_selector . '.blog-overview a span { color: ' . $navigation['overlay_mouseover_color'] . '; }';
					}

					// menu mouseover border
					if(isset($navigation['overlay_border_mouseover_color'])) {
						$output['css'] .= $li_selector . ' a:hover span, ' . $li_selector . '.current-menu-item a span, ' . $li_selector . '.current_page_item a span { border-bottom-color: ' . $navigation['overlay_border_mouseover_color'] . '; }';
						$output['css'] .= '[data-post-type="project"] ' . $li_selector . '.portfolio-grid a span, [data-post-type="post"] ' . $li_selector . '.blog-overview a span { border-bottom-color: ' . $navigation['overlay_border_mouseover_color'] . '; }';
					}

					// menu active font family
					if(isset($navigation['overlay_active_font_family'])) {
						$output['css'] .= $li_selector . '.current-menu-item a span, ' . $li_selector . '.current_page_item a span { ' . semplice_get_font_family($navigation['overlay_active_font_family']) . ' }';
						$output['css'] .= '[data-post-type="project"] ' . $li_selector . '.portfolio-grid a span, [data-post-type="post"] ' . $li_selector . '.blog-overview a span { ' . semplice_get_font_family($navigation['overlay_active_font_family']) . ' }';
					}
		...
		public function get_header_start($nav_settings, $classes) {
			...
			// headroom
			if($nav_settings['navbar_hideonscroll'] == 'enabled') {
			...
			// return header start
			return '<header class="' . $nav_settings['id'] . ' semplice-navbar active-navbar ' . $nav_settings['navbar_mode'] . $classes . '" ' . $style . ' data-cover-transparent="' . $nav_settings['navbar_cover_transparent'] . '" data-bg-overlay-visibility="' . $nav_settings['navbar_bg_visibility_overlay'] . '"' . $mobile_fallback . '>';
		}
